...
Tourepedia organises wide range of trips like family trips,honeymoon trips, educational trips, corporate trips, group trips etc. and activities such as trekking, national park safaris, biking, scuba diving, rafting, camping etc to cater the needs of adventure and experience lovers, in incredible India.</p>
        ...
        <section id="workshop" style="" class="">
        	...
        	<div class="container" style="width: 90%;">
                ...
                <div class="row" data-scrollreveal="enter bottom">
                	<div class="isotope">
                        <div id="iarc" class="bounce animated col-md-offset-2 col-sm-6 col-xs-6 col-md-2 portfolio-item graphic work" style=" box-shadow: 0px 7px 34px 6px;">
                            <a target="_blank" href="#" class=""  data-toggle="modal" data-target="#myModal11">
                                <img src="assets/img/events/icon/IARC.jpg" class="img-centered" alt="" style="">
                                                                <div class="mob caption">
                                    <h3 style="color:black;background-color:brown;display: flex; flex-direction: column;justify-content: center;"><span>IARC</span> </h3>                                    
                                </div>
                            </a>
                        </div>
                        <div id="man" class="bounce animated col-sm-6 col-xs-6 col-md-2 portfolio-item graphic work" style="    box-shadow: 0px 7px 34px 6px;">
                            <a target="_blank" href="#" class=""  data-toggle="modal" data-target="#myModal22">
                                <img src="assets/img/events/icon/manoeuvre.jpg" class="img-centered" alt="" style="width:100%;">
                                                                <div class="mob caption" style="width:100%;">
                                    <h3 style="color:black;background-color: pink;display: flex; flex-direction: column;justify-content: center;"><span>Manoeuvre </span></h3>                                    
                                </div>
                            </a>
                        </div>
    		...
    		<div class="modal-dialog"> 
      			<div class="modal-content" >
      				<div class="modal-header">
        				...
        				<h4 class="modal-title"><span >IARC</span></h4>
      				</div>
        			<div>
  ...
  <center><div id="event-" class="row">
    ...
    <a href="#tab62" data-toggle="tab"><div class="col-md-2 event-nav-content iarc-event">PROBLEM STATEMENT</div></a>
    <a href="#tab66" data-toggle="tab"><div class="col-md-1 event-nav-content iarc-event">ARENA</div></a>
    <a href="#tab63" data-toggle="tab"><div class="col-md-2 event-nav-content iarc-event">JUDGING CRITERIA</div></a>
    <a href="#tab64" data-toggle="tab"><div class="col-md-2 event-nav-content iarc-event">INCENTIVES</div></a>
    <a href="#tab65" data-toggle="tab"><div class="col-md-1 event-nav-content iarc-event">CONTACTS</div></a>
    <a class='common_reg'><div class="col-md-2 event-nav-content iarc-event">REGISTER</div></a>
  </div></center>

  <div class="tab-content">
        <div class="tab-pane fade in active" id="tab61">
        	<h3>To design an autonomous vehicle which traverses the given track in shortest time duration.</h3>
...
<h3>Arena to be updated soon.<br>
...
<h3>In case of any disputes, the decision of the coordinators would be final and binding to all. 
</h3>
        </div>
        <div class="tab-pane fade" id="tab66">
                 <h3>This is sample arena.This is  not exact.</h3>
            <img src="assets/img/events/iarc_arena.png" width="100%">
        </div>
    	<div class="tab-pane fade" id="tab64">
    		<h3>Top three teams will get Certificates of Merit and winners will be felicitated with mementos. The winning team will get the direct entry in the final round of IARC at Techkriti, IIT Kanpur.</h3>
    	</div>
...
<ul><li>9943911352 (KARTHIKEYAN.S)</li>
  		...
  		<div class="modal event-modal" id="myModal22" style="background-image: url(assets/img/events/Manoeuvre.jpg); background-size: cover;">
    		<div class="modal-dialog"> 
      			<div class="modal-content" >
      				<div class="modal-header">
        				<button type="button" class="close" style="color: white;opacity: 1;" data-dismiss="modal" style="font-size: 200%;">&times;</button>
        				<h4 class="modal-title"><span>MANOEUVRE</span></h4>
      				</div>
        			<div>
 ...
 <center><div id="event-" class="row">
  ...
  <div class="tab-content">
        <div class="tab-pane fade in active" id="tab71">
        	<h3>This event requires that participants construct a 4 wheeled gripper robot with constrained dimensions  which could move over various terrains and performs simple tasks such as grabbing and shifting </h3>
        	 <marquee scrollamout='5'><h2 class="awesome">A certificate of participation will be given to all who participate in Events</h2></marquee>
        </div>
        <div class="tab-pane fade" id="tab72">
        	<h3>Bot Specifications</h3>
...
<div class="container-fluid">
  <div class="row contact-col">
    <div class="col-sm-3 col-md-6">
    <div class="col-sm-3 col-md-6 cont">
         <a target="_blank" href="http://aceenggacademy.com/"><img src="assets/img/sponsor/ace.png" width="50%"></a>
    </div>
    <div class="col-sm-9 col-md-6 cont">
         <a target="_blank" href="http://www.mheducation.co.in/"><img src="assets/img/sponsor/mhe.jpg" width="50%"></a>
    </div>
    ...
    <div class="col-sm-3 col-md-6">
    <div class="col-sm-3 col-md-6 cont">
         <a target="_blank" href="https://prodigyfinance.com/"><img src="assets/img/sponsor/prodigy.png" width="50%"></a>
    </div>
    <div class="col-sm-9 col-md-6">
         <a target="_blank" href="http://ohcampus.com/"><img src="assets/img/sponsor/ohcampus.png" width="50%""></a>
    </div>
